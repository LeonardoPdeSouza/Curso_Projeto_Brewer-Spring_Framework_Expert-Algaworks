...
public class CidadesController {
	...
	public String novo(Cidade cidade) {
		return "cidade/CadastroCidade"; // Forward encaminha direto e já retorna (Padrão) 
	}
	...
	public String cadastrar(@Valid Cidade cidade, BindingResult result, Model model, RedirectAttributes attributes) {  
		...
		return "redirect:/cidades/novo"; // Redirect força o navegador a fazer uma nova requisição e começar tudo de novo
	}
